...
bool Triangle::intersectWith(Shape* shape)
{
	return shape->intersectWith(this);
}

bool Triangle::intersectWithCircle(Circle* c)
{
	std::cout << "Triangle + Circle" << std::endl;
	return true;
}

bool Triangle::intersectWithRectangle(Rectangle* r)
{
	std::cout << "Triangle + Rectangle" << std::endl;
	return true;
}

bool Triangle::intersectWithTriangle(Triangle* t)
{
